...
export const KV = {
  ...
  observeDerivedRetry: "mem:observe-derived-retry",
  ...
  indexManifest: (parentScope: string) => `${parentScope}:manifest`,
  indexShard: (
    parentScope: string,
    kind: "bm25" | "vector",
    generation: string,
  ...
  mesh: "mem:mesh",
  branchOverlays: "mem:branch-overlays",
  guardrails: "mem:guardrails",
  decisions: "mem:decisions",
  componentDossiers: "mem:component-dossiers",
  routineCandidates: "mem:routine-candidates",
  ...
  maintenanceLaneState: "mem:maintenance-lane-state",
