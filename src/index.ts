...
import { registerCodexIntegrationProofFunction } from "./functions/codex-integration-proof.js";
...
async function main() {
  ...
  registerRetrievalBlockStorageMigrationFunction(sdk, kv, {
    candidateIds: () => getRetrievalSearchIndex().documentIds(),
  });
